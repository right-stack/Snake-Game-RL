...
class SnakeGameAI: 
    ...
    def _update_ui(self):
        ...
        for pt in self.snake:
            pygame.draw.rect(self.display, BODY1, pygame.Rect(pt.x, pt.y, BLOCK_SIZE, BLOCK_SIZE))
            pygame.draw.rect(self.display, BODY2, pygame.Rect(pt.x+4, pt.y+4, 12, 12))
